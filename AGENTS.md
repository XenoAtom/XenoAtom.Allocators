# XenoAtom.Allocators — Codex Agent Instructions

This library is a fast, lightweight and low-level memory allocator for .NET..

Paths/commands below are relative to this directory.

## Orientation

- Library: `src/XenoAtom.Allocators/`
- Tests: `src/XenoAtom.Allocators.Tests/` (MSTest)
